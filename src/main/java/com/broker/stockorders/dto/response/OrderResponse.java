...
public class OrderResponse {
    ...
    OrderResponse(Long id, Long size, BigDecimal price, String orderSide, String status, LocalDateTime createDate, Long customerId, Long assetId) {
        this.id = id;
        this.size = size;
        this.price = price;
    ...
    public String toString() {
        return "OrderResponse(id=" + this.getId() + ", size=" + this.getSize() + ", price=" + this.getPrice() + ", orderSide=" + this.getOrderSide() + ", status=" + this.getStatus() + ", createDate=" + this.getCreateDate() + ", customerId=" + this.getCustomerId() + ", assetId=" + this.getAssetId() + ")";
    }
    ...
    public static class OrderResponseBuilder {
        ...
        public OrderResponse build() {
            return new OrderResponse(this.id, this.size, this.price, this.orderSide, this.status, this.createDate, this.customerId, this.assetId);
        }

        public String toString() {
            return "OrderResponse.OrderResponseBuilder(id=" + this.id + ", size=" + this.size + ", price=" + this.price + ", orderSide=" + this.orderSide + ", status=" + this.status + ", createDate=" + this.createDate + ", customerId=" + this.customerId + ", assetId=" + this.assetId + ")";
        }
    }
}
