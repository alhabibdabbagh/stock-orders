...
-- Create tables
CREATE TABLE IF NOT EXISTS STOCK_SCHEMA.customer
(
...
CREATE TABLE IF NOT EXISTS STOCK_SCHEMA.asset
(
    id          BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS  idx_orders_asset_id ON STOCK_SCHEMA.orders (asset_id);
CREATE INDEX IF NOT EXISTS idx_orders_customer_id ON STOCK_SCHEMA.orders (customer_id);