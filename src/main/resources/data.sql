...
VALUES (1, 'TRY', 100000, 100000), -- Ahmet'in TRY varlığı
       (2, 'AAPL', 50, 30),        -- Ahmet'in Apple hissesi
       (3, 'TRY', 50000, 50000),   -- Ayşe'nin TRY varlığı
       (4, 'TSLA', 20, 20);
-- Ayşe'nin Tesla hissesi
...
VALUES (1, 10, 1500.00, 'BUY', 'PENDING', '2025-04-10T10:30:00', 2, 2),
       (2, 5, 1200.00, 'SELL', 'CANCELED', '2025-04-09T15:00:00', 2, 1),
       (3, 2, 1000.00, 'BUY', 'MATCHED', '2025-04-08T09:45:00', 3, 3);
